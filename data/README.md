...
- [Descargar dataset (.zip)](https://github.com/Daniel210492/washington-ev-population-analysis/raw/refs/heads/main/data/datos-washington-ev.zip)

Descomprime el archivo y coloca `electric_vehicle_population.csv`
